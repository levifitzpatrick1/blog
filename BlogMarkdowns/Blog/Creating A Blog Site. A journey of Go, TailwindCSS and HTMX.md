...
I am 22, born in 2002. I did not grow up in the world of Myspace pages. My first introduction to any sort of programming was C++ in the context of a VEX Robotics course at my high school. My coding adventures from then on were almost always tied to hardware, via Arduino, Unity and later Java through FRC. My first introduction to building UI's was also non html based, as I picked up flutter because the bird logo was cute (Also the structure of creating widgets was something that I felt more familiar with, coming from a very object oriented background). All this to say I find html difficult.

### So why do this?
It feels weird not being able to make a website as a software developer. I could have made the site in Flutter, most likely in a much shorter time frame than I currently
